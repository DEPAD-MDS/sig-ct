...
export default function AuthPage() {
    return (
        <main className="min-h-screen flex flex-col md:flex-row bg-gray-50">
            ...
            <section className="w-full md:w-1/2 bg-primary-500 text-white flex flex-col justify-center items-center">
                <img src="/assets/background.jpeg" className="w-full h-full object-cover" />
            </section>
                ...
                <div className="w-full max-w-md ">
                    <div className="text-center">
                        ...
                        <div className="max-w-md text-center">
                            ...
                            <p className="text-xl">
                                Sistema Integrado de Gestão de comunidades terapêuticas.
                            </p>
                        </div>
                    </div>
                    <div className=" p-4 flex justify-center items-center rounded-lg">
                        <LoginMsal />
                    </div>
